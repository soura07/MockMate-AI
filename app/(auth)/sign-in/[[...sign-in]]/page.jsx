...
<section className="bg-white">
  <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
    <section className="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
      <img
        alt=""
        src="https://timesproweb-static-backend-prod.s3.ap-south-1.amazonaws.com/Blog_Page_On_Artificial_Intelligence_Interview_Questions_and_Answers_f21aaf79c2.webp"
        className="absolute inset-0 h-medium w-full object-cover opacity-80"
      />
