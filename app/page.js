      ...
      <section className="py-8 bg-white z-50 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
        ...
        <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          ...
          >
            ...
            Create an engaging and thoughtful prompt tailored to your specific needs. This will set the tone for the responses you want to gather, ensuring they are meaningful and aligned with your goals.            </p>
          </a>
          ...
          >
            ...
            <p className="mt-1 text-sm text-gray-600">
            Easily customize your form to match your requirements. Add or adjust fields, refine the structure, and ensure the form is clear and user-friendly for your audience.            </p>
          </a>
          ...
          >
            ...
            <p className="mt-1 text-sm text-gray-600">
            Share your finalized form with your target audience and start collecting responses effortlessly. Analyze the results to gain valuable insights and achieve your objectives.            </p>
          </a>
        </div>
